...
def proposal_draw(zhel_data,zcmb_data,
...
def step_mcmc(single_run_length,zhel_data,zcmb_data,m_B_data,x1_data,c_data,hostmass,ResultsName):
    ...
    P, mu, mu_hat, om, ol, ok, alpha, beta, Mp, dM = likelihood_draw( zhel_data,zcmb_data,
                                                                     m_B_data,x1_data,c_data,
                                                                     hostmass)
#   print P_old, mu, mu_hat, om, ol, ok
    ...
    for i in range(single_run_length):        
        ...
        Mp_temp, dM_temp = proposal_draw(zhel_data,zcmb_data,
                                         m_B_data,x1_data,c_data,
                                         hostmass, om, alpha, 
                                         beta, dM, Mp)
...
def main(NUM_ITER,single_run_length,ResultsName):
    # call functions    
    data_wr = data_stuff()
    ...
    for i in range(NUM_ITER):
        ...
        output.close()
        param_omega_m, param_omega_l, param_omega_k, alpha, beta, Mp, dM, weight, likelihood = step_mcmc(single_run_length,zhel_data,zcmb_data,m_B_data,x1_data,c_data,hostmass_data,ResultsName)
