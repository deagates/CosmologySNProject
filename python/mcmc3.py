...
def likelihood_draw_mini(m_B_data,x1_data,c_data,mu):    
    ...
    return P, mu_hat, alpha, beta
    
    
def step_mcmc_mini(m_B_data,x1_data,c_data,mu) : 
    P_old_mini, mu_hat, alpha, beta = likelihood_draw_mini(m_B_data,x1_data,c_data,mu)   
    for i in n:
        P_new_mini, mu_hat, alpha, beta = likelihood_draw_mini(m_B_data,x1_data,c_data,mu)
    ...
    return alpha, beta, w_mini, P_new_mini, mu_hat    
...
def likelihood_draw(zhel_data,zcmb_data,m_B_data,x1_data,c_data,galax_stell_mass)):
    ...
    alpha, beta, w_mini, P_new_mini, mu_hat=step_mcmc_mini(m_B_data,x1_data,c_data,mu) 
    P = P_new_mini
